...
const pageTemplates: PageTemplate[] = [
  ...
  },
  {
    id: 'akimat-city',
    name: 'Акимат города',
    description: 'Официальный шаблон для городских акиматов с удобным интерфейсом для граждан',
    type: 'government',
    imagePreview: '/templates/akimat-city.jpg'
  },
  {
    id: 'akimat-region',
    name: 'Акимат области',
    description: 'Представительный дизайн для областных акиматов с акцентом на региональные особенности',
    type: 'government',
    imagePreview: '/templates/akimat-region.jpg'
  },
  {
    id: 'ministry-education',
    name: 'Министерство образования',
    description: 'Специализированный шаблон для образовательных ведомств с адаптацией под учебные учреждения',
    type: 'ministry',
    imagePreview: '/templates/ministry-education.jpg'
  },
  {
    id: 'ministry-health',
    name: 'Министерство здравоохранения',
    description: 'Адаптированный шаблон для учреждений здравоохранения с информационными блоками',
    type: 'ministry',
    imagePreview: '/templates/ministry-health.jpg'
  }
];
...
const promptExamples = [
  ...
  'Создать сайт для Акимата города Алматы с формой обращения граждан по вопросам благоустройства и ЖКХ',
  'Создать сайт для Акимата Карагандинской области с формой для подачи предложений по развитию региона',
  'Создать сайт для Министерства здравоохранения с формой записи на прием к специалистам',
  'Создать сайт для Министерства культуры и спорта с формой подачи заявок на участие в культурных мероприятиях',
  'Создать сайт для Акимата Нур-Султана с формой для обращений по вопросам общественного транспорта'
];
