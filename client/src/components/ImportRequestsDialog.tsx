                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-xs text-blue-700">
                      ...
                      <p>3. Система автоматически сопоставит столбцы с полями обращений.</p>
                      <p>4. При наличии столбца 'ID' или 'ExternalId', система будет проверять обращения на дубликаты.</p>
                    </div>
                  </div>
                </div>
              </div>
